...
class DriverValidate extends Validate
{
    ...
    protected $scene = [
        ...
        'truckJobInfo' => ['logistic_delivery_date'],//获取车辆信息
        'doStartJob' => ['logistic_delivery_date','start_kile_metre','start_temprature','start_truck_check'],//开始工作
        'doJobDone' => ['logistic_delivery_date','end_kile_metre','end_temprature','end_truck_check'],//结束工作
