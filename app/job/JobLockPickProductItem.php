...
class JobLockPickProductItem
{
    //php think queue:listen --queue lockPickProductItem
...
//            dump($redis);
            ...
            //1.查询该商品是否有人在操作
            if($product_data['operator_user_id'] > 0){
                //如果操作人是一个人，提示请勿重复操作
                if ($product_data['operator_user_id'] == $data['user_id']) {
